...
|---|---|---|---|
| W0 — Trust baseline | Credible canonical repository baseline; behavioral gaps remain explicitly bounded | CHG-111 Git/package/import/test identity; exact Base pin; resolve actual catalog APIs; F03/F04/F05 APIs and F02 restore contract in later implementation slices; dependency lock; scientific policy version | Canonical repository checks PASS; canonical behavioral gaps are NOT_IMPLEMENTED/NOT_RUN until implemented; Base compatibility smoke; no production claim |
