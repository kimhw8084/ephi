...
- Keep the canonical application narrow; do not copy NiceGUI Base internals or invent missing company bindings. Future F02/F03/F04/F05 checks must target `src/ephi` and report `NOT_IMPLEMENTED`/`NOT_RUN` until real APIs exist.
